...
var nestApiBaseUrlInput = document.querySelector('#nest-api-base-url');
...
function startUpload() {
  ...
  var nestApiBaseUrl = nestApiBaseUrlInput.value;
  ...
  var options = {
    endpoint: `${nestApiBaseUrl}`,
    chunkSize: chunkSize,
    retryDelays: [0, 1000, 3000, 5000],
    parallelUploads: parallelUploads,
    metadata: {
      name: file.name,
      filetype: file.type, // Add file type to metadata
    },
    headers: {
      'X-API-KEY': 'c396a361-8f6d-4437-84fb8816f663-23a0-4954', // Pass the API key to the NestJS proxy
    },
